...
# --- UPDATED SAVE PATH ---
# This points to the new 'data/raw' folder relative to the 'scrapers' folder
JSON_FILE = '../data/raw/keells_master_data.json'
...
def run(playwright):
    ...
    print(f"\nFINISHED! Total Unique Products saved to {JSON_FILE}: {len(master_list)}")
    browser.close()
